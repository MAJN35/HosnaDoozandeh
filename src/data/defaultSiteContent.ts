...
export const defaultSiteContent: SiteContent = {
  "hero": {
    ...
    "specialty": {
      "fa": "روانشناس (سنجش و اندازه‌گیری)",
      "en": "Psychologist (Assessment and Measurement)"
    },
    "quote": {
    ...
    "stats": [
      ...
      },
      {
        ...
        "sub": {
          "fa": "تحت پوشش هدایت تحصیلی",
          "en": "Academic Mentorship"
        }
      },
      {
        "id": "stat-faculty",
        ...
        "sub": {
          "fa": "تیم مدرسان و مشاوران نخبه",
          "en": "Elite Teachers & Counselors"
        }
      }
    ]
  },
  "pillars": [
    {
      ...
      "subtitle": {
        "fa": "شناسایی و شکوفایی استعدادهای فردی",
        "en": "Tailored Cognitive & Personal Pathways"
      },
      "description": {
    ...
    },
    {
      ...
      "title": {
        "fa": "توانمندسازی معلمان",
        "en": "Teacher Empowerment"
      },
      "subtitle": {
        "fa": "سرمایه‌گذاری روی رکن اصلی آموزش",
        "en": "Continuous Faculty Mastery & Agency"
      },
      "description": {
    ...
    },
    {
      ...
      "title": {
        "fa": "تعالی آموزشی",
        "en": "Educational Excellence"
      },
      "subtitle": {
        "fa": "کیفیت‌بخشی و برنامه‌ریزی هدفمند",
        "en": "Rigorous Standards & Strategic Planning"
      },
      "description": {
    ...
    },
    {
      ...
      "title": {
        "fa": "رشد فردی",
        "en": "Holistic Personal Growth"
      },
      "subtitle": {
        "fa": "تربیت شخصیت، هویت و خودباوری",
        "en": "Character, Resilience & Agency"
      },
      "description": {
  ...
  "achievements": [
    {
      ...
      "subtext": {
        "fa": "پایش ظرفیت: ۱۰۰٪ تکمیل سهمیه",
        "en": "Intake & Retention: 100% capacity"
      }
    },
    {
      ...
      "subtext": {
        "fa": "نظرسنجی ادواری اولیا",
        "en": "Parent Audits & Satisfaction"
      }
    },
    {
      ...
      "subtext": {
        "fa": "کادر آموزشی و مشاوره",
        "en": "Academic & Counseling Team"
      }
    },
    {
      "id": "operational-plan",
      ...
      "subtext": {
        "fa": "سند تحول مدرسه",
        "en": "School Transformation Charter"
      }
    },
    {
      "id": "district-rank",
      ...
      "subtext": {
        "fa": "منطقه ۵ شهر تهران",
        "en": "District 5 Inspectorate"
      }
    }
  ],
  "publication": {
    "tag": {
      "fa": "مقاله علمی پژوهشی",
  ...
  "gallery": [
    ...
    },
    {
      ...
      "title": {
        ...
        "en": "Social Responsibility & Child Advocacy"
      },
      "category": {
        "fa": "خدمت اجتماعی",
